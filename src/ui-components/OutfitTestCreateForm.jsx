...
import { createOutfitTest } from "../graphql/mutations";
export default function OutfitTestCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createOutfitTest.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "OutfitTestCreateForm")}
      {...rest}
    >
      <TextField
        label="Created at"
